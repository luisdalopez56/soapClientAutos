...
$index = 0;
                            ...
                            ?>
							<div class="box">
								<a href="<?= $url ?>" class="image fit" title="ver video"><img src="resources/<?=strtolower($marca)?>.png" alt="logo <?=$marca?>" /></a>
								<div class="inner">
                                   <h3><a href="modelos.php?marca=<?= $index+1 ?>&marcaNombre=<?= $marca ?>" data-poptrox="ajax,600x400">Modelos <?= $marca ?></a></h3>
