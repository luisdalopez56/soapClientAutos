...
class GestionAutomoviles
{
    ...
    {
        try {
            $user = "xxxx";  // usuario con el que se va conectar con MySQL
            $pass = "xxxx";  // contraseña del usuario
            $dbname = "xxxx";  // nombre de la base de datos
            $host = "xxxx";  // nombre o IP del host
